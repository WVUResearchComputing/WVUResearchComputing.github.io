...
::
	...
	standby*           up    4:00:00      88/77/2/167 taicm[001-009],tarcl100,tarcs[100,200-206,300-304],
                                                      tbdcx001,tbmcs[001-011,100-103],tbpcm200,tbpcs001,
                                                      tcbcx100,tcdcx100,tcgcx300,tcocm[100-104],tcocs[001-064,100],
                                                      tcocx[001-003],tcscm300,tjscl100,tjscm001,tmmcm[100-108],
                                                      tngcm200,tpmcm[001-006],tsacs001,tsdcl[001-002],tsscl[001-002],
                                                      ttmcm[100-101],tzecl[100-107],tzecs[100-115]
...
The word ``_small_`` indicates that compute nodes associated to the partition offer 96GB of RAM.
The word ``_med_`` indicates that compute nodes associated to the partition offer 192GB of RAM.
The word ``_xl_`` indicates that compute nodes associated to the partition offer 768GB of RAM.
The word ``_gpu_`` indicates that compute nodes associated to the partition include one or more GPU cards.
The words ``_day`` and ``_week`` indicates that those partitions have walltimes of one day or 1 week respectively.
The parition ``comm_gpu_inter`` is used for interactive jobs using GPU cards.
