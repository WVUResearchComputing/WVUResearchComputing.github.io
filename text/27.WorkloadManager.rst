...
As HPC users, the main activity on the cluster is the submission of jobs. 
...
There are two kinds of jobs that you can submit to a HPC cluster: Interactive and non-interactive jobs.
