...
Go to::
  ...
  wget https://www.ks.uiuc.edu/Research/namd/cvs/download/741376/NAMD_Git-2019-12-20_Source.tar.gz
...
The sources come in a tar and compressed file. Untar and uncompress them. Go into the created folder and untar the charm sources too::
  ...
  tar -zxvf NAMD_Git-2019-12-20_Source.tar.gz
  cd NAMD_Git-2019-12-20_Source/
